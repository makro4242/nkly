<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AnaSayfa.ascx.cs" Inherits="Controls_AnaSayfa" %>
<div class="container">

                        <!-- Page-Title -->
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Özet Rapor</h4>
                                <p class="text-muted page-title-alt">Poçan Lojistik Yönetim Ekranı</p>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">Toplam Sefer</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">Toplam Sefer Tutarı</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                        		<div class="card-box">
                        			<h4 class="text-dark header-title m-t-0 m-b-30">Toplam Satışlar</h4>
                        			...
                        			<div class="widget-chart text-center">
	                                	...
	                                	<h5 class="text-muted m-t-20">BuGün</h5>
	                                	<h2 class="font-600">$75</h2>
	                                	<ul class="list-inline m-t-15">
	                                		<li>
	                                			<h5 class="text-muted m-t-20">Bu Hafta</h5>
